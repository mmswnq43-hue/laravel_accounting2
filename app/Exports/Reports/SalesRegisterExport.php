...
class SalesRegisterExport extends BaseReportExport implements WithColumnFormatting
{
    private Collection $rows;

    public function __construct(Collection $rows, string $companyName, string $currency, string $dateRange)
    {
        parent::__construct($companyName, 'سجل المبيعات التفصيلي', $currency, $dateRange);
        $this->rows = $rows;
    }
