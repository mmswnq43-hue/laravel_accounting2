...
class CustomerAnalyticsExport extends BaseReportExport implements WithColumnFormatting
{
    private Collection $rows;

    public function __construct(Collection $rows, string $companyName, string $currency, string $dateRange)
    {
        parent::__construct($companyName, 'تحليل مبيعات العملاء', $currency, $dateRange);
        $this->rows = $rows;
    }
