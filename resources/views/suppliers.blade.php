            ...
            <div class="modal fade" id="editSupplierModal{{ $supplier->id }}" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog modal-xl modal-fullscreen-lg-down user-editor-dialog">
                    <div class="modal-content user-editor-modal">
                        ...
                        <form method="POST" action="{{ route('suppliers.update', $supplier) }}" data-user-editor-form data-initial-dirty="true">
                            @csrf
                            @method('PUT')
    ...
    <div class="modal fade" id="addSupplierModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-xl modal-fullscreen-lg-down user-editor-dialog">
            <div class="modal-content user-editor-modal">
                ...
                <form method="POST" action="{{ route('suppliers.store') }}" data-user-editor-form data-initial-dirty="true">
                    @csrf
